...
import { getProjectByEmployee, getProjectByProjectID, addProjectData, updateProjectData, deleteProjectByID } from '../ManagementApp-Services/ProjectServices';
import { getAllEmployees } from '../ManagementApp-Services/EmployeeServices';

function AddUpdateEmployeeProjectDetails() {
    ...
    function saveAddProject() {
        ...
        addProjectData(newProject)
            ...
            .then(setRefresh(true))
            .then(console.log("Suuceesfull response"))
    }
...
export default AddUpdateEmployeeProjectDetails;